...
var vm = new Vue({
    ...
    methods: {
        getPermisosAct: function () {
            var url = '/api/dt/user/' + laraveljs.id + '/permisos';
        ...
        getPermisosDisp: function () {
            var url = '/api/dt/user/' + laraveljs.id + '/disponibles';
            axios.get(url).then(response => {
        ...
        addPermiso: function (item) {
            console.log(item.id)
            var url = '/configuration/user/' + this.id + '/addpermiso/' + item.id
            axios.get(url).then(response => {
        ...
        deletePermiso: function (item) {
            var url = '/configuration/user/' + this.id + '/deletepermiso/' + item.id
