<form method="POST" v-on:submit.prevent="updateCategory(fillCategory.idCategory)">

    <div class="modal inmodal fade" id="editCategory" tabindex="-1" role="dialog" aria-hidden="true">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input type="text" v-validate="'required'" data-vv-delay="500"
                                    ...
                                    class="form-control" name="nameCategory" v-model="fillCategory.nameCategory"
                                    placeholder="Nombre">
