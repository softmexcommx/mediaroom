...
<body class="skin-sicenet">
    ...
    <div id="wrapper">
        ...
        <!-- Navigation -->
        @include('sicenet_enlinea.layouts.navigation')
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <!-- Page wrapper -->
            @include('sicenet_enlinea.layouts.topnavbar')
    ...
    @include('sicenet_enlinea.configuration.password')
    <!-- Mainly scripts -->
    ...
    <script src="{!! asset('/js/sicenet_enlinea/users/jquery.password.js') !!}"></script>
    ...
    <script type="text/javascript">
        ...
        var channel = pusher.subscribe('for_user_{{ Auth::user()->usudis_cve }}');
                ...
                channel.bind('new-notification', function(data) {
                           ...
                           toastr.success(data.notification, data.notif_subject,{
                            ...
                            "hideMethod": "fadeOut"
                                    ...
                                    // set unread count
                                  let url = "{{ route('sicenet_enlinea.notifications.unread') }}";                          
                                    $.ajax({
                                        method: 'GET',
                                        url: url,
